...
class simpleImage {
    ...
    public function __construct($file) {
        ...
        if(is_file($file)) {
            ...
            if (!$info = getimagesize($file)) {
                throw new systemErrorException("Load image error", "File is not image");
            }
            ...
            switch ($this->type) {
                ...
                default:
                    throw new systemErrorException("Load image error", "Unsupported image format");
                break;
    ...
    public function save($file, $permissions = 0664, $quality = 100, $type = false) {
        ...
        switch ($type) {
            ...
            default:
                throw new systemErrorException("Save image error", "Unsupported image format $type");
            break;
    ...
    public function output($type = false) {
        ...
        switch ($type) {
            ...
            default:
                throw new systemErrorException("Flush image error", "Unsupported image format $type");
            break;
    ...
    public function resize($width, $height, $cropX, $cropY) {
        ...
        imagecopyresampled($new, $this->image, 0, 0, $cropX, $cropY, $width, $height, $this->getWidth() - $dCropX, $this->getHeight() - $dCropY);
