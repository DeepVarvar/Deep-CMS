...
function getExtendedQueryString($prefix = "") {
    ...
    return <<<EXTENDEDINSTALLATIONSTRING
        ...
        (6, '<p>Этот текст никогда не будет показан. Данный документ создан только для того, чтобы создать \"ноду\" в дереве для возможноти вывода в меню ссылки на модуль карты сайта.</p>'),
        ...
        (10, '<p>Этот текст никогда не будет показан, \"нода\" в дереве создана для демонстрации возможности указать в качестве УРЛ ссылку на внешний ресурс.</p>');
